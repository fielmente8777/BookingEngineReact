        ...
        <div className="container footer_top">
          <div className="footer-outer row">
            ...
            <div className="foot_policies col-12 col-sm-4 col-md-4 col-lg-2 col-xl-2">
              ...
              <ul>
                <li>
                  <Link to="/#" onClick={() => settermsShow(true)}>Terms & Conditions</Link>
                </li>
                <li>
                  <Link to="/#" onClick={() => setpaymentShow(true)}>Payment Terms</Link>
                </li>
                <li>
                  <Link to="/#" onClick={() => setcancellationShow(true)}>Cancellation & Refund
                    Policy</Link>
                </li>
                {/* <li>
                  <Link to="/#">FAQs</Link>
