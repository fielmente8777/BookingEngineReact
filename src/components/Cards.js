...
export default function Cards(props) {
  ...
  if (props.roomtype === "1") {
    props.setDeluxAdult(props.Adult);
  }
  if (props.roomtype === "2") {
    props.setSuperDeluxAdult(props.Adult);
  }
  if (props.roomtype === "3") {
    props.setSuiteAdult(props.Adult);
  }
  if (props.roomtype === "4") {
    props.setPremiumAdult(props.Adult);
  }
  if (props.roomtype === "5") {
    props.setPremiereRetreatAdult(props.Adult);
  }
  if (props.roomtype === "6") {
    props.setEliteSuiteAdult(props.Adult);
  }
  if (props.roomtype === "7") {
    props.setGrandDeluxeAdult(props.Adult);
  }
  if (props.roomtype === "8") {
    props.setImperialSuiteAdult(props.Adult);
  }
  if (props.roomtype === "9") {
    props.setSupremeRetreatAdult(props.Adult);
  }
  if (props.roomtype === "10") {
    props.setRoyalDeluxeAdult(props.Adult);
  }
  if (props.roomtype === "11") {
    props.setPrestigeSuiteAdult(props.Adult);
  }
  if (props.roomtype === "12") {
    props.setExclusiveRetreatAdult(props.Adult);
  }
                    ...
                    <div className="land-aminit">
                      <ul>
                        {props.facilities.wifi ? (
                          <li>
                            <i className="fa fa-wifi"></i> Wi-fi
                          </li>
                        ) : (
                          ""
                        )}
                        {props.facilities.television ? (
                          <li>
                            <i className="fa-solid fa-tv"></i> Television
                          </li>
                        ) : (
                          ""
                        )}
                        {props.facilities.airConditonar ? (
                          <li>
                            <i class="fa-regular fa-air-conditioner"></i> Air
                            Conditioner
                          </li>
                        ) : (
                          ""
                        )}
                        {props.facilities.hairdryers ? (
                          <li>
                            <i className="fas fa-baby"></i> Hairdryers
                          </li>
                        ) : (
                          ""
                        )}
                        {props.facilities.coffeeMakers ? (
                          <li>
                            <i className="fa fa-coffee"></i> Coffee Makers
                          </li>
                        ) : (
                          ""
                        )}
                        {props.facilities.directDial ? (
                          <li>
                            <i className="fa fa-phone"></i> Direct Calling
                          </li>
                        ) : (
                          ""
                        )}
                        {props.facilities.tableWithChair ? (
                          <li>
                            <i className="fas fa-book-open"></i> Study Table
                          </li>
                        ) : (
                          ""
                        )}
                        {props.facilities.alarmclock ? (
                          <li>
                            <i className="fa fa-clock-o"></i> Alarm Clock
                          </li>
                        ) : (
                          ""
                        )}
                        {props.facilities.fridge ? (
                          <li>
                            <i className="fas fa-bath"></i> Small Fridge
                          </li>
                        ) : (
                          ""
                        )}
                        {props.facilities.bathroomWithShower ? (
                          <li>
                            <i className="fas fa-bath"></i> Amazing Shower
                          </li>
                        ) : (
                          ""
                        )}
                        {props.facilities.electronicLocker ? (
                          <li>
                            <i className="fa fa-lock"></i> Security Locker
                          </li>
                        ) : (
                          ""
                        )}
                        {props.facilities.freeBreakfast ? (
                          <li>
                            <i className="fa-solid fa-mug-saucer"></i> Free
                            Breakfast{" "}
                          </li>
                        ) : (
                          ""
                        )}
                        {props.facilities.kidEquipment ? (
                          <li>
                            <i className="fas fa-baby"></i> Kids Toys
                          </li>
                        ) : (
                          ""
                        )}
                        ...
                        {props.facilities.FlatscreenTV ? (
                          <li>Flatscreen TV</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Privatepool ? (
                          <li>Private Pool</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Electrickettle ? (
                          <li>Electric Kettle</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Spabath ? <li>Spa Bath</li> : ""}
                        {props.facilities.RoomAmenities ? (
                          <li>Room Amenities</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Cots ? <li>Cots</li> : ""}
                        {props.facilities.Clothesrack ? (
                          <li>Clothes rack</li>
                        ) : (
                          ""
                        )}
                        ...
                        {props.facilities.Heatedpool ? (
                          <li>Heated Pool</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Infinitypool ? (
                          <li>Infinity Pool</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Plungepool ? (
                          <li>Plunge Pool</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Poolcover ? <li>Pool Cover</li> : ""}
                        {props.facilities.Pooltowels ? (
                          <li>Pool Towels</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Rooftoppool ? (
                          <li>Rooftop Pool</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Dressingroom ? (
                          <li>Dressing Room</li>
                        ) : (
                          ""
                        )}
                        ...
                        {props.facilities.Ironingfacilities ? (
                          <li>Ironing Facilities</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Hottub ? <li>Hottub</li> : ""}
                        {props.facilities.Mosquitonet ? (
                          <li>Mosquito Net</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.PrivateEntrance ? (
                          <li>Private Entrance</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Sofa ? <li>Sofa</li> : ""}
                        {props.facilities.Soundproofing ? (
                          <li>Soundp Roofing</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.SeatingArea ? (
                          <li>Seating Area</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Pantspress ? (
                          <li>Pants Press</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Washingmachine ? (
                          <li>Washing Machine</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Desk ? <li>Desk</li> : ""}
                        {props.facilities.Hypoallergenic ? (
                          <li>Hypoaller Genic</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Cleaningproducts ? (
                        ...
                        {props.facilities.Featherpillow ? (
                          <li>Feather Pillow</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Non_feather_pillow ? (
                          <li>Non Feather Pillow</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Bathroom ? <li>Bathroom</li> : ""}
                        {props.facilities.Privatebathroom ? (
                          <li>Private Bathroom</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Shared_bathroom ? (
                          <li>Shared Bathroom</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Toilet_paper ? (
                          <li>Toilet Paper</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Bidet ? <li>Bidet</li> : ""}
                        {props.facilities.Bath_shower ? (
                          <li>Bath Shower</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Bathrobe ? <li>Bathrobe</li> : ""}
                        {props.facilities.Free_toiletries ? (
                          <li>Free Toiletries</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Additional_toilet ? (
                          <li>Additional Toilet</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Hairdryer ? <li>Hairdryer</li> : ""}
                        {props.facilities.Shared_toilet ? (
                          <li>Shared Toilet</li>
                        ) : (
                          ""
                        )}
                        ...
                        {props.facilities.Additional_bathroom ? (
                        ...
                        {props.facilities.Satellitechannels ? (
                        ...
                        {props.facilities.Streamingservice_like_Netflix ? (
                          <li>Streaming Service Like Netflix</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Dining_table ? (
                          <li>Dining Table</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Bottle_of_water ? (
                          <li>Bottle of Water</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Chocolate_or_cookies ? (
                        ...
                        {props.facilities.Outdoor_furniture ? (
                        ...
                        {props.facilities.Key_card_access ? (
                        ...
                        {props.facilities.Alarm_clock ? (
                          <li>Alarm Clock</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Wake_up_service ? (
                        ...
                        {props.facilities.Extra_blankets ? (
                        ...
                        {props.facilities.Garden_view ? (
                          <li>Garden View</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Lake_view ? <li>Lake View</li> : ""}
                        {props.facilities.Landmark_view ? (
                          <li>Landmark View</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Mountain_view ? (
                          <li>Mountain View</li>
                        ) : (
                          ""
                        )}
                        ...
                        {props.facilities.Hearingaccessible ? (
                          <li>Hearing Accessible</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Adaptedbath ? (
                          <li>Adapted Bath</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Raisedtoilet ? (
                          <li>Raised Toilet</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Loweredsink ? (
                          <li>Lowered Sink</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Showerchair ? (
                          <li>Shower Chair</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Entertainment_family_services ? (
                          <li>Entertainment Family Services</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Baby_safety_gates ? (
                        ...
                        {props.facilities.Smokealarm ? (
                          <li>Smoke Alarm</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Fire_extinguisher ? (
                          <li>Fire Extinguisher</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Safety_features ? (
                          <li>Safety Features</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Air_purifiers ? (
                          <li>Air Purifiers</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Physicaldistancing ? (
                          <li>Physical Distancing</li>
                        ) : (
                          ""
                        )}
                        {props.facilities.Handsanitiser ? (
